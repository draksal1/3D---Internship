...
{
    // This is
    // the camera class as it could be set up after the tutorials on the website.
    ...
    public class Camera
    {
        ...
        private float _yaw = -MathUtil.PiOverTwo; // Without this, you would be started rotated 90 degrees right.
        ...
        {
            return Matrix.PerspectiveFovLH(_fov, AspectRatio, 0.01f, 100f);
        }
