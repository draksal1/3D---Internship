...
namespace Window3D
{
    ...
    public class Window : GameWindow
    {
        ...
        private readonly string _wayToShaders = ".//..//..//..//..//lab4/Shaders//";

        private readonly string _wayToCommonFiles = ".//..//..//..//..//CommonFiles//";

        private Vector3 _lightPos = new Vector3(1.0f, 1.0f, 1.0f);
        ...
        { ClientSize = (width, height), Title = title })
        {
            ...
            _lightShader = new Shader(_wayToShaders + "shader.vert", _wayToShaders + "flashLight.frag");
            _shader = new Shader(_wayToShaders + "shader.vert", _wayToCommonFiles + "shader.frag");
        }
        ...
        protected override void OnLoad()
        {
            ...
            float[] _vertices = _cube.GetVertices();
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // Выводим время между кадрами в консоль
            long tempTime = frameStopwatch.ElapsedMilliseconds;
            if (tempTime == 0)
            {
                _fps = 0;
            }
            ...
            {
                _fps = 1000 / frameStopwatch.ElapsedMilliseconds;
            }

            _imGuiWindow.SetFps(_fps);
            ...
            for (int i = 0; i < _imGuiWindow.GetCount() - 1; i++)
            {
                matrix *= Matrix4.CreateTranslation(new Vector3(0.0f, 1.0f, 0.0f));
                _lightShader.SetMatrix4("model", matrix);
                GL.DrawArrays(PrimitiveType.Triangles, 0, 36);
            }
        ...
        private void ChangeShader()
        {
            ...
            {
                _lightShader = new Shader(_wayToShaders + "shader.vert", _wayToShaders + "pointLight.frag");
                //FOR POINT LIGHT
            ...
            {
                _lightShader = new Shader(_wayToShaders + "shader.vert", _wayToShaders + "directionalLight.frag");
                //FOR DIRECTIONAL LIGHT
                _lightShader.SetVector3("light.direction", new Vector3(-0.1f, 0.3f, -0.5f));
            }
            else
            {
                _lightShader = new Shader(_wayToShaders + "shader.vert", _wayToShaders + "flashLight.frag");
